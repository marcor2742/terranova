...
namespace terranova.Server.Migrations
{
    ...
    [Migration("20250331163835_cocktailsdb")]
    partial class cocktailsdb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("terranova.Server.Models.Cocktail", b =>
                {
                    ...
                    b.Property<long?>("InstructionsId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("terranova.Server.Models.CocktailIngredient", b =>
                {
                    ...
                    b.Property<string>("MeasureIM")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MeasureMT")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("CocktailKey", "IngredientsKey");
